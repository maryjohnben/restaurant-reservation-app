export default function isPastDateAndClosed(reservation_date, reservation_time) {
    ...
    if (today > day) {
      return "Date and/or time cannot be in the past. Please select another date/time.";
    }
    if(day.getHours() < 10 || (day.getHours() === 10 && day.getMinutes() < 30)) {
      return 'Restaurant will not open until 10:30 AM. Please reserve a later time.'
        }
